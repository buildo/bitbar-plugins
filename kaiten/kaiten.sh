...
KAITEN_MEMBERS_COUNT=`echo $KAITEN_COM_RESULT | jq -c "$KAITEN_MEMBERS_QUERY" | wc -l`
KAITEN_RESPONSIBLE_COUNT=`echo $KAITEN_COM_RESULT | jq -c "$KAITEN_RESPONSIBLE_QUERY" | wc -l`
